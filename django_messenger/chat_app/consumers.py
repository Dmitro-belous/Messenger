...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        group_send_dict = {"type": "chat.message", "message": 'joined', "username": self.user.username,
        ...
        await self.channel_layer.group_send(self.room_group_name, group_send_dict)
    ...
    async def disconnect(self, close_code):
        ...
        await self.channel_layer.group_send(
            self.room_group_name, {"type": "chat.message", "message": 'left', "username": self.scope['user'].username,
                                   "usernames": usernames, 'whom': 'room'}
        )
